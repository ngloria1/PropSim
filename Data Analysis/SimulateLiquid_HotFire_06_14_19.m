...
test_data.test_data_file = '2019_06_14_Hotfire.mat'; % File from which to import test data
...
inputs.fuel.injector_area = 2.75*mm_to_m^2;
...
%Tank Volume
inputs.fuel.V_tank = 3.79*L_to_m3; 

%Nitrous Volume
inputs.fuel.V_l = 1.39*L_to_m3; 
...
inputs.c_star_efficiency = 0.884;

%Nozzle Throat diameter
inputs.d_throat = 2.545e-2;
