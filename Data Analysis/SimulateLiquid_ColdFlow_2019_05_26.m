...
test_data.test_data_file = '2019_05_26_Coldflow.mat'; % File from which to import test data
...
%Injector Exit Area
inputs.ox.injector_area = 31*mm_to_m^2;
inputs.fuel.injector_area = 0.371*mm_to_m^2;
...
%Nitrous Volume
inputs.ox.V_l = (1-0.084)*inputs.ox.V_tank; 
...
inputs.fuel_pressurant.set_pressure = 603*psi_to_Pa;
