...
test_data.test_data_file = '5_09_18_burn.mat'; % File from which to import test data
test_data.t_offset = -2413; % Time offset of test data wrt simulation data [s]
...
%Injector Exit Area
inputs.ox.injector_area = 29.6*mm_to_m^2;
inputs.fuel.injector_area = 2.2*mm_to_m^2;
...
%-------Oxidizer Properties--------
%Tank Volume
inputs.ox.V_tank = 6.7*L_to_m3; 

%Nitrous Volume
inputs.ox.V_l = 6.03*L_to_m3; 
...
inputs.fuel_pressurant.set_pressure = 630*psi_to_Pa;
